...
def menu():
    menu = """\n
    xxxxxxxxxxxxxxxxxxxxxxx MENU xxxxxxxxxxxxxxxxxxxxxx
    [d]\tDEPOSITAR
    [s]\tSACAR
    [e]\tEXTRATO
    [nc]\tNOVA CONTA
...
def exibir_extrato(clientes):
    ...
    print("\nXXXXXXXXXXXXX EXTRATO XXXXXXXXXXXXXX")
    extrato = ""
    tem_transacao = False
...
def criar_conta(numero_conta, clientes, contas):
    ...
    conta = ContaCorrente.nova_conta(
        cliente=cliente, numero=numero_conta, limite=1000, limite_saques=50
    )
    contas.append(conta)
